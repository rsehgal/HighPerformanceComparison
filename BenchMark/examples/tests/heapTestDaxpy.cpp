...
int main()
{
std::system("rm -rf timingHeapDaxpy.txt");
std::ofstream outfile;
outfile.open("timingHeapDaxpy.txt",std::ios::app); //File to store timing information
...
bl_c[i] = bl_b[i] + bl_a[i]*scalar;//+bl_d[i];
